var Petition = function () {
    ...
    var moduleUrl = appUrl + '/admin/petitions';
    var petitionId;

    var initDatatable = function () {
        datatable = $('#table-petition').DataTable({
            bSort: false,
            ajax: {
                url: moduleUrl,
                data: function (d) {
    ...
    var handleSubmit = function () {
        $('#form-petition').on('submit', function (e) {
            e.prpetitionDefault();
            if (e.isTrigger) return false; // prpetition submit twice

            form = this;

            // $('<input />').attr('type', 'hidden').attr('name', "content_id").attr('value', petitionApp.petition.link_content.content_id).appendTo($(form));
            // $('<input />').attr('type', 'hidden').attr('name', "content_type_id").attr('value', petitionApp.petition.link_content.content_type_id).appendTo($(form));
