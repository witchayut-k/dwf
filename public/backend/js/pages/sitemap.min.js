...
/*!******************************************************!*\
  !*** ./resources/assets/backend/js/pages/sitemap.js ***!
  \******************************************************/
var Sitemap = function () {
  ...
  var handleSubmit = function handleSubmit() {
    $('#form-sitemap').on('submit', function (e) {
      ...
      form = this; // $('<input />').attr('type', 'hidden').attr('name', "content_id").attr('value', sitemapApp.sitemap.link_content.content_id).appendTo($(form));
