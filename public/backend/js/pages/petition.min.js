...
/*!*******************************************************!*\
  !*** ./resources/assets/backend/js/pages/petition.js ***!
  \*******************************************************/
var Petition = function () {
  ...
  var handleSubmit = function handleSubmit() {
    $('#form-petition').on('submit', function (e) {
      ...
      form = this; // $('<input />').attr('type', 'hidden').attr('name', "content_id").attr('value', petitionApp.petition.link_content.content_id).appendTo($(form));
