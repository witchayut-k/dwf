...
/*!***************************************************!*\
  !*** ./resources/assets/backend/js/pages/feed.js ***!
  \***************************************************/
var Feed = function () {
  ...
  var handleSubmit = function handleSubmit() {
    $('#form-feed').on('submit', function (e) {
      ...
      form = this; // $('<input />').attr('type', 'hidden').attr('name', "content_id").attr('value', feedApp.feed.link_content.content_id).appendTo($(form));
