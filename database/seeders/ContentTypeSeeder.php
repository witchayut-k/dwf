...
class ContentTypeSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('content_types')->insert([
            ...
            ['name' => 'ประชาพิจารณ์/ร่างประกาศ/เอกสาร/ประกวดราคา', 'published' => true],
            ['name' => 'ประกาศประกวดราคา', 'published' => true],
            ['name' => 'ประกาศผลการเสนอราคา', 'published' => true],
            ['name' => 'ทำเนียบผู้บริหาร', 'published' => true],
            ['name' => 'ร่างเอกสารประกวดราคา (e-Bidding) และร่างเอกสารซื้อหรือจ้างด้วยวิธีสอบราคา', 'published' => true],
            ['name' => 'ประกาศเชิญชวน', 'published' => true],
            ['name' => 'ประกาศรายชื่อผู้ชนะการเสนอราคา / ประกาศผู้ได้รับการคัดเลือก', 'published' => true],
            ['name' => 'ยกเลิกประกาศเชิญชวน', 'published' => true],
            ['name' => 'ยกเลิกประกาศรายชื่อผู้ชนะการเสนอราคา / ประกาศผู้ได้รับการคัดเลือก', 'published' => true],
            ['name' => 'เปลี่ยนแปลงประกาศเชิญชวน', 'published' => true],
            ['name' => 'เปลี่ยนแปลงประกาศรายชื่อผู้ชนะการเสนอราคา', 'published' => true],
        ]);
    }
}
